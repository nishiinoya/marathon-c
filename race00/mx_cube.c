...
void upper_side(int DIAGONAL_LENGTH,
                int HORIZONTAL_LENGTH);
void print_front(int HORIZONTAL_LENGTH);
void lower_side(int row, int HORIZONTAL_LENGTH,
                int VERTICAL_LENGTH);
...
void mx_cube(int n) {
    ...
    for (int row = 0; row < VERTICAL_LENGTH; row++) {
        ...
        int back_corner_idx = VERTICAL_LENGTH -
                              DIAGONAL_LENGTH - 1;
...
void lower_side(int row,
                int HORIZONTAL_LENGTH, int VERTICAL_LENGTH) {
    int start_idx = HORIZONTAL_LENGTH + 1;
    int end_idx = start_idx + VERTICAL_LENGTH - row - 1;
